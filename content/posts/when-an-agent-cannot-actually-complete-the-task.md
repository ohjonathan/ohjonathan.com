...
If you want the public evidence bundle while you read, start with the companion [research memo](/evidence/model-behavior/2026-04-18_model-behavior-research-memo.md), then the mirrored [accountability proposal](/evidence/model-behavior/2026-04-18_model-integrity-proposal.md), then the [quarantined artifacts](/reference/model-behavior-evidence/#quarantined-artifacts). A rendered index for the full bundle is at [Model Behavior Evidence](/reference/model-behavior-evidence/).
...
*If you want the public evidence chain, start with the [research memo](/evidence/model-behavior/2026-04-18_model-behavior-research-memo.md), then the [proposal](/evidence/model-behavior/2026-04-18_model-integrity-proposal.md), then the [quarantined artifacts](/reference/model-behavior-evidence/#quarantined-artifacts). If you want a cleaner entry point, the full mirrored bundle is indexed at [Model Behavior Evidence](/reference/model-behavior-evidence/). If you want to talk about what this means for agent design, I'm on [LinkedIn](https://www.linkedin.com/in/ohjohnny).*
